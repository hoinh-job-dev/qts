...
#   > crontab -u ubuntu -e
# 手順2. 下記を追記してください。
#   */10 * * * * /var/www/html/QT/application/qts_checkCompleteOrders.sh
...
date "+%Y/%m/%d %H:%M:%S | checkCompleteOrders cron job " >> "${vlog_dir}/${vlog_file}"
php index.php Operator checkCompleteOrders