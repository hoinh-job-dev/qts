...
#   > crontab -u ubuntu -e
# 手順2. 下記を追記してください。
#   */5 * * * * /var/www/html/QT/application/qts_autoInputBtcAddr.sh
...
date "+%Y/%m/%d %H:%M:%S | auto input BTC address cron job " >> "${vlog_dir}/${vlog_file}"
php index.php Operator autoInputBtcAddr