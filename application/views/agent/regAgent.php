...
<div class="l-order ">
    <section class="order-main">
        ...
        <?php } ?>
        <div class="whitebox">
            <form action="<?php echo base_url('Agent/complete'); ?>" method="post" enctype="multipart/form-data" id="order" class="selectorZipcloudSearchWrapper">
                ...
                <div id="step1">
                    ...
                    <p>
                        <label for="familyname" id="familyname_label" class="lbl-name-layout">姓</label>
                    ...
                    <p>
                        <label for="family_name_kana" id="familyname_label" class="lbl-name-layout">セイ</label>
                    ...
                    <div class="terms-container">
                        <p class="txt-blue">
                            <a href="<?php echo base_url($this->config->item('path_pdf_doc') . $this->config->item('doc_privacypolicy')); ?>" target="_blank" tabindex="-1">個人情報保護方針を読む
                            </a>
                        </p>
                        <p>
                    ...
                    <div class="terms-container">
                        <p>
                            ...
                            foreach($this->config->item('role_agent_doc_marketer') as $agent_role => $doc_name) {
                                if($agent_role == $rank) {
                                    ?><a href="<?php echo base_url($this->config->item('path_pdf_doc') . $doc_name); ?>" target="_blank" tabindex="-1" style="color:#00f;">利用規約を読む</a><?php
                                    break;
                                }
                            }
                            ?>
                        ...
                        <p>
                            <label id="rule_agreement_label" class="rule_agreement">
                                <input type="checkbox" id="rule_agreement" name="rule_agreement" value="<?php echo $user->rule_agreement?>" <?php echo !isset($userPostData['rule_agreement']) ? '' : ' checked="checked"'; ?>
                                />&nbsp;内容に同意する
                            </label> 
                        </p>
                    </div>
                ...
                <div id="step3">
                    ...
                    <div class="file-upload btn btn-primary">
                        <input type="file" accept="image/*" name="photo1" id="photo1" class="photo1 upload" onchange="previewPhoto(this);"/>
                    </div>
                    <input type="text" id="fileuploadurl" readonly placeholder="ファイル名が入ります" class="photo1">
                    <div class="order-pht">
...
<script type="text/javascript" src="<?php echo base_url('js/agent/regAgent.js'); ?>"></script>