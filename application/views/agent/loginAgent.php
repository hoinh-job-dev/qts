	<div class="l-login">
		<section class="login-main">
			<div class="mainbox">
			<div class="whitebox">
				<h1><img src="<?php echo base_url('img/top/marvelous_title.png'); ?>" width="237" height="104" alt="Marvelous 代理店ログイン"></h1>
				<form action="<?php echo base_url('Agent/home'); ?>" method="post" id="login">
					<p>
					...
					<input type="button" value="login" onclick="return login();">
                                ...
                                <ul>
                                    ...
                                    <li style="margin-bottom:10px;"><label onclick="box_expand()">< パスワードをお忘れの方 ></label>
                                        <div id="ask_password_box" style="display:none;">
                                        <form action="<?php echo base_url('Agent/ask_password'); ?>" id="ask" method="post">
                                            <p>Emailアドレスを入力いただき、「問合せメール送信」ボタンをクリックしてください。<br>後程、パスワード再設定に関するメールをお送りいたします。</p>
                                            <p>
                                                email<br>
