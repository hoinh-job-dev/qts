 ...
 * @access private
 */
	private $userAgent = "Alta PHP Library";
...
/**
 * Send post request to remote server. Make sure that CURL is enabled.
 *
 * @param string $url
 * @param string $jsonData
 * @access public
 * @return response data that is returned by remote server
 */
    public function postJSON($url, $jsonData) {
    	log_message('debug', '=========postJSON => URL: ' . $url);
    	log_message('debug', '=========postJSON => jsonData: ' . $jsonData);
